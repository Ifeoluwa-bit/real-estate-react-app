...
export default function Featured() {
  return (
    <div name='about' className='featured'>
        ...
        <div className="container">
            ...
            <div className="span-3 img-details">
                ...
                <div className="top">
                    <h2>456, Bcne St. Lucas, UK</h2>
                    <p>House for Sale</p>
                    <p className="price">$2,877,000</p>
                </div>
                ...
                <div className="info-grid">
                    ...
                    <div>
                        ...
                        <div className="info">
                            <p className="bold">Est Payment:</p><p>$18,686/mo</p>
                        </div>
                    </div>
